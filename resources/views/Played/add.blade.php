	...
	<h2>Input Data Played</h2>
			...
			@csrf
				<table>					
					...
					<div class="col-sm-5">
							<select name="tracks_id" class="form-control" style="background-color: #FFE3E3; color: indianred">
				...
				<div class="form-group row">
					<div>
						<div class="col-sm-10">
						<button type="submit" class="btn" style="background-color: #FFA0A0 " >Simpan</button></div>
					</div>
			</form>
