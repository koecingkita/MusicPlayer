...
<body>
	...
	<table>
		...
		<div class="col-sm-5">
			<input type="text" name="tracks_name" value="{{ $rows->tracks_name}}" style="background-color: #FFE3E3; color: indianred" class="form-control" id="inputEmail3">
		</div>
		</div>
		...
		<div class="col-sm-5">
			<input type="file" name="tracks_file" id="inputEmail3" style="color: indianred">
		</div>
		</div>
		...
		<div class="col-sm-5">
			<input type="text" name="tracks_time" value="{{ $rows->tracks_time}}" style="background-color: #FFE3E3; color: indianred" class="form-control" id="inputEmail3">
		</div>
		</div>
